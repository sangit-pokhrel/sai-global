    ...
    return (
        <div className="p-5">
            <div className="text-center">
                ...
                <p className="text-gray-600 mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean commodo ligula eget dolor....</p>
                <div className="relative w-full max-w-md mx-auto mb-8">
                    ...
                    <button className="absolute right-2 top-2 bg-transparent">
                        <svg className="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-4.35-4.35m1.32-5.32A7.5 7.5 0 113.5 10.5a7.5 7.5 0 0114.5 0z"></path>
                        </svg>
                    </button>
                </div>
            </div>
            <div className="bg-pink-100 p-4 rounded-lg mb-5">
                <span className="bg-blue-500 text-white rounded-full px-3 py-1 font-bold">MONTESSORI</span>
            </div>
