    ...
    return (
        <div className='bg-[#fff]'>
            ...
            <div className="p-8 text-center flex-wrap">
                ...
                <p className="text-justify bg-[#EFD9FD] leading-relaxed max-w-4xl mx-auto rounded-md text-gray-700 px-[4rem] py-8" style={{borderLeft: "2px solid #222", borderRight: "2px solid #222"}}>
